...
#     latitude = 13.405144417641665
#     longitude =  121.21518105221196
#     coordinates = f"{latitude},{longitude}"
...
@app.on_event("startup")
async def on_startup():
    logger.info("🚀 FastAPI app started. Forecast scheduler is active.")# from fastapi import FastAPI, HTTPException, WebSocket
# from fastapi.middleware.cors import CORSMiddleware
# import os
# import httpx
# import asyncio
