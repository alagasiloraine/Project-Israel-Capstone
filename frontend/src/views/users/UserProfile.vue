                  ...
                  <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <div class="mt-6">
                      <button 
                        ...
                        class="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-2.5 rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center disabled:opacity-70 disabled:cursor-not-allowed"
                      >
...
// Disable PIN section if authType is 'password'
...
const executeLogout = () => {
  showModal.value = false; // Hide modal after confirmation
...
onMounted(async () => {
  ...
  try {
    ...
    if (userDoc.exists()) {
      ...
      // Disable password or pin update section
