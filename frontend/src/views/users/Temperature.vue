    ...
    <div class="flex-1 overflow-auto bg-gradient-to-br from-green-50 to-emerald-50 p-8">
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center text-sm text-gray-500">
          <span class="text-blue-600">Temperature</span>
                    ...
                    >
                      <div class="flex items-center justify-between">
                        ...
                        <div class="flex flex-col ml-2">
                          <ChevronUp 
                            class="h-4 w-4 -mb-1" 
                            :class="sortConfig.key === header.key && !sortConfig.asc ? 'text-red-600' : 'text-gray-500'"
                          />
                          <ChevronDown 
                            class="h-4 w-4" 
                            :class="sortConfig.key === header.key && sortConfig.asc ? 'text-red-600' : 'text-gray-500'"
...
<<<<<<< HEAD
  if (temp >= 32) return 'bg-red-200 text-red-900'
  if (temp >= 28) return 'bg-yellow-200 text-yellow-900'
  return 'bg-green-200 text-green-900'
=======
  if (temp >= 32) return 'bg-red-100 text-red-800'
  if (temp >= 28) return 'bg-yellow-100 text-yellow-800'
