              ...
              <div class="p-3">
                ...
                <div v-if="isWebSocketConnected" class="space-y-2.5">
                  ...
                  <div class="flex justify-between items-center text-xs">
                    ...
                    <span class="font-medium text-gray-800 truncate ml-2 max-w-[120px]">api.projectisrael.com</span>
                  </div>
                </div>
...
// Connection status
const isWebSocketConnected = ref(true) // Default to connected for demo
const wifiStrength = ref(85) // Default to 85% strength for demo
const wifiNetwork = ref('RODA_2002') // Default network name
const ipAddress = ref('192.168.1.105') // Default IP address
const wsLatency = ref(23) // Default WebSocket latency in ms
const wsUptime = ref('2h 34m') // Default WebSocket uptime
